...
<head>
	...
	<!-- Pace -->
	<link href="resources/endless/css/pace.css" rel="stylesheet">
	
	<!-- Color box -->
	<link href="resources/endless/css/colorbox/colorbox.css" rel="stylesheet">
	
	<!-- Morris -->
	<link href="resources/endless/css/morris.css" rel="stylesheet"/>	
	
	<!-- Endless -->
	<link href="resources/endless/css/endless.min.css" rel="stylesheet">
  ...
  <body class="">
	...
	<!-- Popup Overlay -->
	<script src='resources/endless/js/jquery.popupoverlay.min.js'></script>
	
	<!-- Slimscroll -->
	<script src='resources/endless/js/jquery.slimscroll.min.js'></script>
	
	<!-- Modernizr -->
	<script src='resources/endless/js/modernizr.min.js'></script>
	
	<!-- Cookie -->
	<script src='resources/endless/js/jquery.cookie.min.js'></script>

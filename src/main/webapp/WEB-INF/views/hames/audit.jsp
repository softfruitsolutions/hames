			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input class="form-control input-sm" type="text" placeholder="Date Created" readonly>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						<input class="form-control input-sm" type="text" placeholder="Date Modified" readonly>
					</div>
				</div>
			</div>
		</div>
